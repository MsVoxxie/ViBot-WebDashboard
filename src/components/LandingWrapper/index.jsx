        ...
        <Flex height='100vh' alignItems='center' justifyContent='center'>
            <Flex width='35vh' direction='column' background={formBackground} p={6} rounded={6}>
                ...
                <Flex justify='center' mb={6} alignItems='center'>
                    <Heading size='sm' mr={2}>With ViBot You Can:</Heading>
                <TextLoop>
                ...
                <Flex justify='center' direction='column' alignItems='center'>
                    <Button mb={6} colorScheme="teal" variant="solid" onClick={login} >Login with Discord</Button>
                    <Button size='xs' width='fit-content' mb={0} onClick={toggleColorMode} >Toggle Theme</Button>
                </Flex>
            </Flex>
        </Flex>
      );
